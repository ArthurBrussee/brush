//! Compute projected splat data for visible gaussians. Mirrors
//! `project_visible.wgsl`. PF already culled non-finite-cov2d splats so
//! this kernel trusts `calc_cov2d` here.
